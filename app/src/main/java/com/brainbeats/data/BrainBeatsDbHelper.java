...
public class BrainBeatsDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_TABLE_MIX = CREATE_TABLE + BrainBeatsContract.MixEntry.TABLE_NAME + " (" +
                        ...
                        BrainBeatsContract.MixEntry.COLUMN_NAME_DURATION + COLUMN_TYPE_INT_NULL + COMMA_SEPERATOR +
                        BrainBeatsContract.MixEntry.COLUMN_NAME_IS_UPVOTE + COLUMN_TYPE_INT_NULL + COMMA_SEPERATOR +
